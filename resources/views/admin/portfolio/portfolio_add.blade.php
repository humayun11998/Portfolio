            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="portfolio_name" class="form-control @error('portfolio_name') is-invalid @enderror" type="text" value="">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="portfolio_title" class="form-control @error('portfolio_title') is-invalid @enderror" type="text" value="">
                    ...
                    <input class="btn btn-info waves-effect waves-light" type="submit" value="Add Portfolio Data">
