            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="blog_title" class="form-control @error('blog_title') is-invalid @enderror" type="text" value="{{ $blog->blog_title }}">
                            @error('blog_title')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="blog_tags" class="form-control" type="text" value="{{ $blog->blog_tags }}" data-role="tagsinput">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img id="showImage" class="img-thumbnail" width="150px" src="{{ asset($blog->blog_image) }}" alt="Portfolio image">
                        </div>
                    </div>
