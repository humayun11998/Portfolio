...
<head>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <!-- JAVASCRIPT -->
<script src="{{ asset('backend/assets/libs/jquery/jquery.min.js') }}" defer></script>
...
<!-- jQuery Vector Map -->
<script src="{{ asset('backend/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js') }}" defer></script>
<script src="{{ asset('backend/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-us-merc-en.js') }}" defer></script>
...
<!-- Responsive Examples -->
<script src="{{ asset('backend/assets/libs/datatables.net-responsive/js/dataTables.responsive.min.js') }}" defer></script>
<script src="{{ asset('backend/assets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}" defer></script>

<!-- Dashboard Initialization -->
<script src="{{ asset('backend/assets/js/pages/dashboard.init.js') }}" defer></script>
